...
## Setup
- Worktree: ~/src/a/claude-paint-r10-arm2 (branch r10-arm2). Work only there. Do not push.
- Your painting: paintings/src/bin/r10_winter_b.rs. Run: `cargo paint r10_winter_b`
...
- Scratch: run `~/.local/bin/agent-tmp r10_winter_b` once and export
...
1. paintings/src/bin/r10_winter_b.rs and final renders out/r10_winter_b.png (1000px) and
   out/r10_winter_b_full.png (3200px).
2. notes/r10_winter_b.md, written continuously: the composition and why (what in
