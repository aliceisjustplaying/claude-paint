-- notes/time: a sky, then a hill's edge painted into it. Variant: nextday.
--   easel run notes/time/edge_nextday.lua   (see notes/time.md)
...
--@ chunk 3 · clock 0
-- the next day: the sky set overnight
rest(16)
