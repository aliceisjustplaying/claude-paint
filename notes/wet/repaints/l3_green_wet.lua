...
-- Adapted for the r6-wet engine (notes/wet.md §8): chunk 11 lays the wood's lights lean and fewer (load 0.3, coverage 1.6 for 2.2).
--@ chunk 1 · clock 0
...
-- (r6-wet) the lights no longer sink into the wet dark by themselves: laid from a lean brush,
-- fewer, so they merge into it instead of standing as dots
work(lit, {hand="hatch", tool="round 1.5", length={2, 4}, coverage=1.6, load=0.3, angle=function(x,y) return 2.4*tn(x+9,y) end, medium=0.2,
