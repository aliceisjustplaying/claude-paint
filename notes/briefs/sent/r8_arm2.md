...
## Setup
- Worktree: ~/src/a/claude-paint-r8-arm2 (branch r8-arm2). Work only there. Do not push. Commit
...
- Scratch: run `~/.local/bin/agent-tmp arm2` once and export
...
1. Your painting's source (see your medium) and plain renders copied to
   notes/round8/arm2/painting_1000.png and painting_3200.png (lossless).
2. notes/round8/arm2/notes.md, written continuously: the composition and
