-- notes/time: a sky, then a hill's edge painted into it. Variant: dry.
--   easel run notes/time/edge_dry.lua   (see notes/time.md)
...
--@ chunk 3 · clock 0
-- the sketchbook habit: dry() before a passage that goes over earlier work
dry()
