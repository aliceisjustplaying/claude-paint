-- notes/time: a sky, then a hill's edge painted into it. Variant: instant.
--   easel run notes/time/edge_instant.lua   (see notes/time.md)
...
--@ chunk 3 · clock 0
-- hand time off: the hill follows the sky in no time at all
