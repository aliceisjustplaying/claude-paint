...
## Setup
- Worktree: ~/src/a/claude-paint-r11-astra (branch r11-astra). Work only there. Do not push.
- Your painting: paintings/src/bin/r11_winter_astra.rs. Run: `cargo paint r11_winter_astra`
...
- Scratch: run `~/.local/bin/agent-tmp r11_winter_astra` once and export
...
1. paintings/src/bin/r11_winter_astra.rs and final renders out/r11_winter_astra.png (1000px) and
   out/r11_winter_astra_full.png (3200px).
2. notes/r11_winter_astra.md, written continuously: the composition and why (what in
