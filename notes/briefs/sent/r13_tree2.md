...
## Setup
- Worktree: ~/src/a/claude-paint-r13-tree2 (branch r13-tree2). Work only there. Do not push.
- Your painting: paintings/src/bin/r13_tree2.rs. Render at one size only,
  2400 px wide: `cargo paint r13_tree2 -- --full --width 2400` (the whole,
  -> out/r13_tree2_full.png), `-- --full --width 2400 --crop x0,y0,x1,y1`
...
- Scratch: run `~/.local/bin/agent-tmp r13_tree2` once and export
...
1. paintings/src/bin/r13_tree2.rs and the final render out/r13_tree2_full.png
   (2400px).
2. notes/r13_tree2.md, written continuously: what you tried and why; your
