...
## Setup
- Worktree: ~/src/a/claude-paint-r12-tree1 (branch r12-tree1). Work only there. Do not push.
- Your painting: paintings/src/bin/r12_tree1.rs. Render at one size only,
  2400 px wide: `cargo paint r12_tree1 -- --full --width 2400` (the whole,
  -> out/r12_tree1_full.png), `-- --full --width 2400 --crop x0,y0,x1,y1`
...
- Scratch: run `~/.local/bin/agent-tmp r12_tree1` once and export
...
1. paintings/src/bin/r12_tree1.rs and the final render out/r12_tree1_full.png
   (2400px).
2. notes/r12_tree1.md, written continuously: what you tried and why; your
