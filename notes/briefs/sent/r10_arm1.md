...
## Setup
- Worktree: ~/src/a/claude-paint-r10-arm1 (branch r10-arm1). Work only there. Do not push.
- Your painting: paintings/src/bin/r10_winter_a.rs. Run: `cargo paint r10_winter_a`
...
- Scratch: run `~/.local/bin/agent-tmp r10_winter_a` once and export
...
1. paintings/src/bin/r10_winter_a.rs and final renders out/r10_winter_a.png (1000px) and
   out/r10_winter_a_full.png (3200px).
2. notes/r10_winter_a.md, written continuously: the composition and why (what in
