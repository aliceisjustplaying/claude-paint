...
## Setup
- Worktree: ~/src/a/claude-paint-r11-study3 (branch r11-study3). Work only there. Do not push.
- Your painting: paintings/src/bin/r11_study3.rs. Run: `cargo paint r11_study3`
...
- Scratch: run `~/.local/bin/agent-tmp r11_study3` once and export
...
1. paintings/src/bin/r11_study3.rs and final renders out/r11_study3.png (1000px) and
   out/r11_study3_full.png (3200px).
2. notes/r11_study3.md, written continuously: what you tried and why; your
