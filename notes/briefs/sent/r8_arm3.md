...
## Setup
- Worktree: ~/src/a/claude-paint-r8-arm3 (branch r8-arm3). Work only there. Do not push. Commit
...
- Scratch: run `~/.local/bin/agent-tmp arm3` once and export
...
1. Your painting's source (see your medium) and plain renders copied to
   notes/round8/arm3/painting_1000.png and painting_3200.png (lossless).
2. notes/round8/arm3/notes.md, written continuously: the composition and
