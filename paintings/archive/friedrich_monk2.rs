...
fn main() {
    ...
    let mut c = o.canvas(|| st.prepare(o.width, 1.56, o.seed));
    ...
    if o.stage("sky 2", &mut c, &mut rng) {
    ...
    if o.stage("blend", &mut c, &mut rng) {
    ...
    let cracks = paint::Cracks { island_mm: 5.0, ground_um, dirt: 0.6, ..paint::Cracks::aged(0) };
