...
Summer. Any time of day, any subject Friedrich might have chosen in a green summer landscape.

## Setup
- Worktree: ~/src/a/claude-paint-r10-arm3 (branch r10-arm3). Work only there. Do not push.
- Your painting: paintings/src/bin/r10_summer.rs. Run: `cargo paint r10_summer`
...
- Scratch: run `~/.local/bin/agent-tmp r10_summer` once and export
...
1. paintings/src/bin/r10_summer.rs and final renders out/r10_summer.png (1000px) and
   out/r10_summer_full.png (3200px).
2. notes/r10_summer.md, written continuously: the composition and why (what in
