...
## Setup
- Worktree: ~/src/a/claude-paint-r13-tree3 (branch r13-tree3). Work only there. Do not push.
- Your painting: paintings/src/bin/r13_tree3.rs. Render at one size only,
  2400 px wide: `cargo paint r13_tree3 -- --full --width 2400` (the whole,
  -> out/r13_tree3_full.png), `-- --full --width 2400 --crop x0,y0,x1,y1`
...
- Scratch: run `~/.local/bin/agent-tmp r13_tree3` once and export
...
paintings/src/bin/study_*.rs. paintings/src/rocks.rs is another painter's
habit for rocks: you may read it to learn the form primitives, but motifs
belong to the painter: paint your own trees, rocks, figures and everything
else in your program. Do not read git history or any other notes.
...
1. paintings/src/bin/r13_tree3.rs and the final render out/r13_tree3_full.png
   (2400px).
2. notes/r13_tree3.md, written continuously: what you tried and why; your
