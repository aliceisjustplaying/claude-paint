# A study: one trunk against sky and snow
...
## Your study
One passage, not a whole landscape: a dark tree trunk rising out of snow
and crossing a pale evening sky, on a small canvas. Where the trunk meets
the sky and where it enters the snow is the whole subject. Leave off the
aged finish (no craquelure, no aged varnish): the paint alone has to carry
it. Make it look deliberately painted, even if the drawing is clumsier.

## Setup
- Worktree: ~/src/a/claude-paint-r11-study1 (branch r11-study1). Work only there. Do not push.
- Your painting: paintings/src/bin/r11_study1.rs. Run: `cargo paint r11_study1`
...
- Scratch: run `~/.local/bin/agent-tmp r11_study1` once and export
...
1. paintings/src/bin/r11_study1.rs and final renders out/r11_study1.png (1000px) and
   out/r11_study1_full.png (3200px).
2. notes/r11_study1.md, written continuously: what you tried and why; your
