...
## Setup
- Worktree: ~/src/a/claude-paint-r11-study2 (branch r11-study2). Work only there. Do not push.
- Your painting: paintings/src/bin/r11_study2.rs. Run: `cargo paint r11_study2`
...
- Scratch: run `~/.local/bin/agent-tmp r11_study2` once and export
...
1. paintings/src/bin/r11_study2.rs and final renders out/r11_study2.png (1000px) and
   out/r11_study2_full.png (3200px).
2. notes/r11_study2.md, written continuously: what you tried and why; your
