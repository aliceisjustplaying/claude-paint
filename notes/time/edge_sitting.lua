-- notes/time: a sky, then a hill's edge painted into it. Variant: sitting.
--   easel run notes/time/edge_sitting.lua   (see notes/time.md)
...
--@ chunk 3 · clock 0
-- the same sitting: the hill follows the sky after the time the sky took
