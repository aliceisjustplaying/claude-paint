-- notes/time: paintings/lua/example.lua painted in three sittings with hand time on
-- (the example's day-long waits between stages replaced by sittings and rests).
--   easel run notes/time/example_sittings.lua   (see notes/time.md)
