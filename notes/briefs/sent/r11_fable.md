...
## Setup
- Worktree: ~/src/a/claude-paint-r11-fable (branch r11-fable). Work only there. Do not push.
- Your painting: paintings/src/bin/r11_winter_fable.rs. Run: `cargo paint r11_winter_fable`
...
- Scratch: run `~/.local/bin/agent-tmp r11_winter_fable` once and export
...
1. paintings/src/bin/r11_winter_fable.rs and final renders out/r11_winter_fable.png (1000px) and
   out/r11_winter_fable_full.png (3200px).
2. notes/r11_winter_fable.md, written continuously: the composition and why (what in
